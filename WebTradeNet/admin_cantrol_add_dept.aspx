<%@ Page Language="VB" MasterPageFile="~/admin_controls_master.master" AutoEventWireup="false" CodeFile="admin_cantrol_add_dept.aspx.vb" Inherits="admin_cantrol_add_dept" title="TradeNet" %>
    ...
    <div class="admin_contr_main_right_insede_mid">
        <table cellpadding="0" cellspacing="0" style="width:60%;margin-left:auto;margin-right:auto;vertical-align:top;">
            <tr>
                ...
                <td style="width:50%">
                    <asp:TextBox ID="txt_d_name" runat="server" AutoPostBack="True"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td valign="top">
