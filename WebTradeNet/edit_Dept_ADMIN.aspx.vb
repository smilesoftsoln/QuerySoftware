...
Partial Class edit_Dept_ADMIN
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            cmd.Parameters.AddWithValue("@wis", "ADMIN")
    ...
    Protected Sub btn_ok_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_ok.Click
        ...
        If cmd.ExecuteNonQuery Then
            command("sp_update_admin_by_id")
            cmd.Parameters.AddWithValue("@f_id", forign_id)
            cmd.Parameters.AddWithValue("@new_email", txt_email.Text)
            If cmd.ExecuteNonQuery Then
                Response.Redirect("edit_Dept_ADMIN.aspx")
            End If
