...
Namespace somman_functions_NM
    Public Class commen_funcs
        ...
        End Sub
        Public Shared Sub auto_mail_dept()
            Dim strim As String = ""
        ...
        '*********************************
        Public Shared Sub auto_mail_branch()
            Dim strim As String = ""
            Dim this_stts As String = "Solved"
            Dim arr_tot_depts As Integer = 0
            Dim i As Integer = 0
            ...
            While i <= tot_branch_
                ...
                strim &= "</table>"
                If String.IsNullOrEmpty(branch_mngr_emails(i)) Then
                Else

                    If (branch_mngr_emails(i).Contains("tradenetstockbroking.in")) Then
