    ...
    Public Class projectercon
        ...
        Public ReadOnly Property ConObj() As Object
            ...
            Get
                ...
                ' development()
                con.ConnectionString = "Data Source=.\SQLEXPRESS;AttachDbFilename='D:\Softwares Under Development\Changes Since In Pune\3 sep 2017 Query\Database\tn_CAREE_bita.mdf';Integrated Security=True;Connect Timeout=30;User Instance=True"

                'live
                '  con.ConnectionString = "Data Source=.\SQLEXPRESS;Initial Catalog=Query;Integrated Security=True;"
                con.Open()
                ConObj = con
                '   End Using
