<%@ Page Language="C#" MasterPageFile="~/todo/senior_manager.master" AutoEventWireup="true" CodeFile="senior_manager_login_next.aspx.cs" Inherits="senior_manager_login_next" Title="Untitled Page" %>
                        ...
                        <ul>
                              <li><a href="Assign_task.aspx">Assign Task</a></li>
						       <li><a href="Assign_task.aspx?parameter=1">Assign Task Self</a></li>        
                                  <li><a href="senior_manager_view_all_task.aspx">View Task's</a></li>						
