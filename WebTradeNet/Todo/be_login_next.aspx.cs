...
public partial class be_login_next : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlDataReader dr12 = cmd_get_branch_name_and.ExecuteReader();
        dr12.Read();
        Session.Add("branch_id", dr12[0].ToString());
        Session.Add("branch_name", dr12[1].ToString());
        dr12.Close();
        con.Close();
   ...
   /////////////////////////////// for overdue task ..  ///////////////////////////////////////
      ...
      ////////////////////////////////// coding for email /////////////////////////////////////// 
                ...
                con.Open();
                SqlCommand cmd_get_bhead=new SqlCommand("select l.name as name,l.email_id from t_m_login as l,t_m_branch as b where b.name='"+ Session["branch_name"].ToString() +"' and l.post="+ 4 +" and l.forign_id=b.id ",con);
                SqlDataReader dr_get_email_id=cmd_get_bhead.ExecuteReader();
                dr_get_email_id.Read();
                string branch_head = dr_get_email_id[0].ToString();
    ...
    ////////////////////////////////////////////////////////todo overdue complete /////////////////////////////////////
        ...
        while (rdr.Read())
        {
            ...
            //string tm = _hour + ":" + _min + ":" + sec + " " + ampm;
            //string tms=DateTime.Now.ToLongTimeString().ToString();

            //if (Convert.ToInt32(tm) >Convert.ToInt32( tms))
            //{
