...
public partial class be_login_next : System.Web.UI.Page
{
    string strim;
    ...
    {
        //lblloginer.Text = Request.QueryString["parameter"];
        ...
        DateTime enddate_overdue = Convert.ToDateTime(edt3);
      ...
      /////////////////////////////// todays todo ///////////////////////////////////////////////////////////////
        ...
        while (rdr.Read())
        {
            ...
            DateTime x =Convert.ToDateTime( rdr[2]);
            string xy =x.ToLongTimeString();
            strim += xy;
        ...
        con.Open();
        SqlCommand cmd_get_recorda = new SqlCommand("select id as cnt from t_m_task where creator = " + get_id + "and status = 'U' and enddate >= '" + startdate.ToString("dd-MMM-yyyy 00:00:00") + "'", con);
        SqlDataReader dr_as = cmd_get_recorda.ExecuteReader();

        int xa = 0;
        while (dr_as.Read())
        {
            rowcounta[xa] = Convert.ToInt32(dr_as[0].ToString());
            xa = xa + 1;
        }
        dr_as.Close();
        con.Close();
        ...
        for (int i = 0; i < rowcounta.Length; i++)
        {
            if (con.State == ConnectionState.Open)
            {
                con.Close();
            ...
            con.Open();
            SqlCommand cmd_get_assign_designation = new SqlCommand("select usertype from t_m_task where id = " + Convert.ToInt32(rowcounta[i]), con);
            ...
            if ((assign_type == "SRBMNG") || (assign_type == "SRMNG") || (assign_type == "MNG"))
            {
                ...
                con.Open();
                SqlCommand cmd_get_info = new SqlCommand("select t.id,l.name,t.usertype,t.enddate,p.[desc],t.subject from t_m_task as t, t_m_login as l, t_m_priority as p where t.assign_to = l.id and t.priority = p.id and t.id = " + rowcounta[i], con);
            ...
            else if ((assign_type == "HOD") || (assign_type == "DE"))
            {
                ...
                con.Open();
                SqlCommand cmd_get_info = new SqlCommand("select t.id,l.name,t.usertype,t.enddate,p.[desc],t.subject,d.dept_name from t_m_task as t,t_m_dept as d, t_m_login as l, t_m_priority as p where t.assign_to = l.id and t.dept = d.id and t.priority = p.id and t.id = " + rowcounta[i], con);
                SqlDataReader dr_get_info = cmd_get_info.ExecuteReader();
            ...
            else if ((assign_type == "BH") || (assign_type == "BE"))
            {
                ...
                con.Open();
                SqlCommand cmd_get_info = new SqlCommand("select t.id,l.name,t.usertype,t.enddate,p.[desc],b.name ,t.subject from t_m_task as t,t_m_branch as b, t_m_login as l, t_m_priority as p where t.assign_to = l.id and t.branch = b.id and t.priority = p.id and t.id = " + rowcounta[i], con);
                SqlDataReader dr_get_info = cmd_get_info.ExecuteReader();
