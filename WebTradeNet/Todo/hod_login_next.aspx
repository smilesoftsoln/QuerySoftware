<%@ Page Language="C#" MasterPageFile="~/Todo/hod.master" AutoEventWireup="true" CodeFile="hod_login_next.aspx.cs" Inherits="hod_login_next" Title="Untitled Page" %>
            ...
            <td width="100%">
                ...
                <asp:Label ID = "lblusercontrols" runat = "server" Text = "User Controls" 
                 Font-Bold="True" Font-Size="Large" ForeColor="Red" ></asp:Label>
                        ...
                        <td width = "20%" align = "right">
                            <asp:Label ID = "Label2" runat = "server" Text = "Dept Name :- " 
                              Font-Bold="True" Font-Size="Small" ForeColor="Gray" ></asp:Label>
                        
                        </td>
                        <td align = "left" width = "20%">                          
                         
                            <asp:Label ID = "lbldeptname" runat = "server" Text = "User Controls" 
                              Font-Bold="True" Font-Size="Small" ForeColor="Blue" ></asp:Label>
                        </td>
                    </tr>
                 ...
                 <td width="20%">
                        <ul>
                        <li>  <asp:LinkButton ID="LinkButton4" runat="server" onclick="LinkButton4_Click" >Assign Todo</asp:LinkButton>
						</li>
                    ...
                    <td width="20%">
                    <ul>
                    <%--<li><a href="hod_view_alltodo.aspx">View All ToDo</a></li>--%>
						<li><a href="hod_view_all_task.aspx">View All Tasks Assigned To Me</a></li>
						<li><a href="view_assigned_task.aspx">View All Assigned Task By Me</a></li>
