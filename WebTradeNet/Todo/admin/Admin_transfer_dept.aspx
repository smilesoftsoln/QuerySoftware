<%@ Page Language="C#" MasterPageFile="~/todo/admin/master_admin.master" AutoEventWireup="true" CodeFile="Admin_transfer_dept.aspx.cs" Inherits="admin_Admin_asign_exist_hod" Title="Untitled Page" %>
                ...
                <td>
                        ...
                        <table width = "100%" >
                            ...
                            <tr>
                                ...
                                <td style="width: 170px;height: 35px;"  >
                                        <asp:Label ID = "Label7" runat = "server"  Text = "To HOD:-" ></asp:Label>  <asp:Label id = "star2" runat = "server" Text = " *" ForeColor = "Red"></asp:Label>
                                </td>
