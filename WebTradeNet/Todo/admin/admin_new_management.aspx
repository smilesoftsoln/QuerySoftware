<%@ Page Language="C#" MasterPageFile="~/todo/admin/master_admin.master" AutoEventWireup="true" CodeFile="admin_new_management.aspx.cs" Inherits="admin_admin_new_management" Title="Untitled Page" %>
...
<table width = "100%">
            <tr>
                <td rowspan="3" style="width: 307px" align="center">
                        ...
                        <asp:Label runat = "server" Text = "Create Management" ID="Label1" Font-Bold="True" 
                            ...
                            <tr>
                                <td style="width: 188px; height: 35px;">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                        Display="None" ErrorMessage="Please enter Management" 
                                        ControlToValidate="txtmngmnt" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                
                                </td>
                            
                                <td style="width: 170px; height: 35px;" >
                                        <asp:Label ID = "lblusertype" runat = "server"  Text = "Enter Management :- " ></asp:Label> <asp:Label id = "star1" runat = "server" Text = " *" ForeColor = "Red"></asp:Label>   
                                </td>
                                
                                <td style="height: 35px; height: 35px;" >
                                        <asp:TextBox ID = "txtmngmnt" runat = "server" Width = "200px" ></asp:TextBox>
                                </td>
                            </tr>
