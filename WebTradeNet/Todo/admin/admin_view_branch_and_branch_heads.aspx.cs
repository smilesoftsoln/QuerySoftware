...
public partial class admin_admin_view_all_branches : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd_get_branches_heads = new SqlCommand("SELECT b.id, b.name,l.name AS bh FROM t_m_branch as b LEFT OUTER JOIN t_m_login as l ON b.bh_id = l.id", con);        
