<%@ Page Language="C#" MasterPageFile="~/todo/admin/admin_todo_panel.master" AutoEventWireup="true" CodeFile="Admin_Assign_todo.aspx.cs" Inherits="Admin_Assign_todo" Title="Untitled Page" ValidateRequest="false" %>
 <%@ Register
         ...
         <tr style="height:40px">
           ...
           <td width = "60%" >
               ...
               <asp:TextBox ID="DateTextBox1"   autocomplete="off" runat="server"></asp:TextBox>
                <AjaxControlToolkit:CalendarExtender  ID="calw" runat="server" TargetControlID="DateTextBox1"  ></AjaxControlToolkit:CalendarExtender>
             <asp:ImageButton runat="server" ID="imgPopup" ImageUrl="~/images/Calendar.png" 
                   onclick="imgPopup_Click" />
             </td> 
        </tr>
