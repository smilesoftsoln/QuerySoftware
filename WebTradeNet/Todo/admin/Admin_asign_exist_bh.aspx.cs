...
public partial class admin_Admin_asign_exist_hod : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            con.Open();
            SqlCommand cmd_get_branch_bhless = new SqlCommand("admin_get_branch_bhless", con);
            cmd_get_branch_bhless.CommandType = CommandType.StoredProcedure;
            SqlDataReader dr = cmd_get_branch_bhless.ExecuteReader();
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        {
             Response.Write(@"<script language='javascript'>alert('Branch Assigned TO Existing BH Successfully..!')</script>");
        }        
        con.Close();
        ...
        {
            Response.Write(@"<script language='javascript'>alert('Branch Assigned TO Existing BH Successfully..!')</script>");
            Response.Redirect("Admin_asign_exist_bh.aspx");
        }
