<%@ Page Language="VB" MasterPageFile="~/todo/admin/admin_Pnl.master" AutoEventWireup="false" CodeFile="view_all_users.aspx.vb" Inherits="admin_view_all_users" title="View All Users" %>
...
<table>
    <tr>
        ...
        <asp:DropDownList ID="cbo_typ" runat="server" AutoPostBack="True">
            ...
            <asp:ListItem>MNGT</asp:ListItem>
        </asp:DropDownList>
    </fieldset>
        </td>
