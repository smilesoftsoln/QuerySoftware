...
public partial class senior_manager_view_alltodo : System.Web.UI.Page
{
 ...
 strim += "<th width='50px'align = 'left' bgcolor='#EEEEEE' style='color:#000000'" + ">";
  ...
  strim += "<th width='50px'align = 'left' bgcolor='#EEEEEE' style='color:#000000'" + ">";
        ...
        con.Open();
        SqlCommand cmd_get_Todo = new SqlCommand("get_view_all_task_srbmng_or_srmng", con);
        cmd_get_Todo.CommandType = CommandType.StoredProcedure;
        cmd_get_Todo.Parameters.Clear();
        cmd_get_Todo.Parameters.AddWithValue("@startdate", dt);
        cmd_get_Todo.Parameters.AddWithValue("@enddate", edt);
        ...
        while (rdr.Read())
        {
            ...
            DateTime x = Convert.ToDateTime(rdr[3]);
        ...
        view_srmng_task.InnerHtml = strim;
