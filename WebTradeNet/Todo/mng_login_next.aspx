<%@ Page Language="C#" MasterPageFile="~/todo/mng_master.master" AutoEventWireup="true" CodeFile="mng_login_next.aspx.cs" Inherits="be_login_next" Title="Untitled Page" %>
        ...
        <tr>
            <td width="100%">
                <%--<table width = "100%">
                    <tr>
                        <td align = "right">
                             <asp:Label ID = "lblmngid" runat = "server" Text = "User Controls" 
                 ...
                 Font-Bold="True" Font-Size="Large" ForeColor="Red" ></asp:Label>
					...
					<li>	 <asp:LinkButton ID="LinkButton3" runat="server" 
                            onclick="LinkButton3_Click"  >View Todo Assigned by Me</asp:LinkButton></li> 
                                 ...
                                 <td width="20%">
                                    <ul>
                                       <li><a href="view_assigned_task.aspx">View All Task</a></li>            
                                ...
                                <td width="20%">
                                    <ul>
                                        <li><a href="view_solved_task.aspx">View Solved Task</a></li> 
                                          <li>
                                         <a href="view_overdue_task.aspx">View Overdue Task</a>&nbsp; 
                                <asp:Label ID="lbl_overdue" runat="server" Font-Bold="True" ForeColor="#003300" 
                                    Text="L" Visible="False">
                                    </asp:Label>
                                &nbsp;<asp:Image ID="img_overd_alert" runat="server" ImageUrl="~/images/LIGHT.gif" 
                                    Visible="False" />
                                            </li>
<%--						                  <li><a href="View_login_information.aspx">View Login Information</a></li>                                                --%></ul>
                                </td>
                           </tr>    
                        </table> 
