...
Partial Class hod_login_Next
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strim &= "	            </td>"
        strim &= "	        </tr>"
        command("sp_get_ticketsby_dept_id")
        rdr = cmd.ExecuteReader
        While rdr.Read
        ...
        ''   SqlQry = "sp_get_escalated _ticketsby_dept_id"
        ...
        If (lbl_dept.Text.Contains("CUSTOMERCARE")) Then
            mng_queries.Visible = False
        Else

            mng_queries.Visible = True
        End If
