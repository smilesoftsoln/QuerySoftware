<%@ Page Language="VB" AutoEventWireup="false" CodeFile="mng_login_next.aspx.vb" Inherits="mng_login_next" %>
...
window.onload=loadTopMenu;
	...
	<div class="top">
		...
		<a href="#" rel="Therapy">
                ...
                <a href="Todo/mng_login_next.aspx" rel="" target="_blank">My
                        Task Master</a>
            </div>
	</div>	
	<div class="welcome_pan">
		<div class="welcome_pan_left">
		    TradeNet Head Of Department 
            <asp:Label ID="Label1" runat="server" Text="HOD"></asp:Label>
            Panel:<br />
		...
		<div class="welcome_pan_right">
            <div>
                <a href="mng_runing_queryes.aspx" onclick="return hs.htmlExpand(this, { contentId: 'highslide-html', objectType: 'iframe',		objectWidth: 900, objectHeight: 800} )" class="highslide">View Running Queries</a>
 ...
 <a href="hod_online_users.aspx" onclick="return hs.htmlExpand(this, { contentId: 'highslide-html', objectType: 'iframe',		objectWidth: 900, objectHeight: 800} )"
                        class="highslide">Online Users</a>
                                            <div class="highslide-html-content" id="Div3" style="width: 900px">
	                <div class="highslide-move" style="border: 0; height: 25px; padding: 0px; cursor: default">
	                   <div class="data_admin_mid_main_top_3">
	                       <div style="float:left;clear:left;">
	                       View Online Users
	                ...
	                <div class="highslide-body" id="Div4"></div>
                    </div>
            </div>
           ...
           <a href="admin/view_all_ticks.aspx" >View All Queries</a>
                ...
                <LI>
                    <div>
                        <a href="change_password.aspx" onclick="return hs.htmlExpand(this, { contentId: 'highslide-html', objectType: 'iframe',		objectWidth: 500, objectHeight: 250} )" class="highslide">Change Password</a>
                            <div class="highslide-html-content" id="Div1" style="width: 500px">
	                        <div class="highslide-move" style="border: 0; height: 25px; padding: 0px; cursor: default">
	                           <div class="data_admin_mid_main_top_3">
	                               <div style="float:left;clear:left;">
	                                Change Password
	                        ...
	                        <div class="highslide-body" id="Div2"></div>
                            </div>
                    </div>
                </LI>
