<%@ Page Language="VB" AutoEventWireup="false" CodeFile="hod_login_Next.aspx.vb"
    Inherits="hod_login_Next" %>
    ...
    <div class="main_page">
        ...
        <div class="welcome_pan">
            ...
            <div class="welcome_pan_right">
                <div>
                    <a href="hod_runing_queryes.aspx" onclick="return hs.htmlExpand(this, { contentId: 'highslide-html', objectType: 'iframe',		objectWidth: 900, objectHeight: 800} )"
        ...
        <div class="admin_updater_long" id="mng_queries" runat="server" >
