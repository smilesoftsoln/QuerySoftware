<%@ Page Language="VB" MasterPageFile="~/admin_controls_master.master" AutoEventWireup="false" CodeFile="edit_dept_emp.aspx.vb" Inherits="edit_dept_emp" title="Untitled Page" %>
...
<asp:Panel ID="Panel1" runat="server" GroupingText="Edit Department Employee Info."  Width="750px" CssClass="for_alpha_panal">
   Select Username : 
...
<table cellpadding="0" cellspacing="0" style="width:60%;margin-left:auto;margin-right:auto;">
            <tr>
             ...
             <tr>
                ...
                <td>
                    <asp:TextBox ID="txt_joining" runat="server" ReadOnly="True"></asp:TextBox>
                </td>
            </tr>
             <tr>
                <td>
