<%@ Page Language="VB" MasterPageFile="~/admin_controls_master.master" AutoEventWireup="false" CodeFile="edit_branch_info.aspx.vb" Inherits="edit_branch_info" title="Untitled Page" %>
...
<asp:Panel ID="Panel1" runat="server" GroupingText="Edit Branch Info."  Width="750px" CssClass="for_alpha_panal">
   Select Branch : 
    <asp:DropDownList ID="cbo_branch" runat="server" AutoPostBack="True">
    </asp:DropDownList>
