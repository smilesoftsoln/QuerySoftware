<%@ Page Language="VB" AutoEventWireup="false" CodeFile="mng_view_all_ticks.aspx.vb" Inherits="mng_view_all_ticks" %>
...
window.onload=loadTopMenu;
	...
	<div class="menu_1">
		<a href="mng_login_next.aspx"  >Home</a>
		<a href="#">About Us</a>
		<a href="#">Support</a>
		<a href="#">Join Us</a>
	</div>	
	...
	<div class="welcome_pan3" style="margin-bottom:20px;">
        ...
        &nbsp;<br />
           ...
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        <asp:ImageButton ID="btn_exp" runat="server" 
            ImageUrl="~/images/btn_export.gif" />
	    <asp:LinkButton ID="LinkButton3" runat="server">ReSet</asp:LinkButton><br />
	    <fieldset >
           ...
           Query Type</legend>
		    ...
		    <tr>
		        <td style="height: 20px">
		            <img src="images/typ_escelated.jpg" /> Escalated
		        </td>
		        <td style="height: 20px">
		            <img src="images/typ_normal.JPG" /> Normal
		        </td>
		        <td style="height: 20px">
		            <img src="images/typ_transferd.jpg"/> Transferred
		        </td>
		        <td style="height: 20px">
		            <img src="images/typ_deleted.jpg"/> Deleted
		        </td>
		    </tr>
		</table>
	...
	<div class="main_panal">
		<div class="admin_updater_long">
			<div class="admin_updater_long_top">
				<img src="images/Admin_Login_Next_updater_long_ico.jpg"  align="middle"/><asp:Label ID="pnl_ticket_typ" runat="server" Text=""></asp:Label> 
			</div>
		...
		<div class="search_links">
		    ...
		    <a href="mng_search_tickets.aspx">Search &nbsp; &nbsp;<asp:LinkButton ID="LinkButton2"
                runat="server">View Deleted Tickets</asp:LinkButton>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
