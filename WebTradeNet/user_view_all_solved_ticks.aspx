<%@ Page Language="VB" AutoEventWireup="false" CodeFile="user_view_all_solved_ticks.aspx.vb" Inherits="user_view_all_solved_ticks" %>
	...
	<div class="main_panal">
		<div class="admin_updater_long">
			<div class="admin_updater_long_top">
				<img src="images/Admin_Login_Next_updater_long_ico.jpg"  align="middle"/> All SOLVED Tickets
			</div>
