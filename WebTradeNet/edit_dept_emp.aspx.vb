...
Partial Class edit_dept_emp
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            cmd.Parameters.AddWithValue("@wis", "DE")
            rdr = cmd.ExecuteReader
            While rdr.Read
                cbo_user.Items.Add(rdr("username_"))
                Session.Item(rdr("username_")) = rdr("id")
            End While
        End If
    End Sub
    ...
    Protected Sub cbo_user_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_user.SelectedIndexChanged
        ...
        command("sp_get_info_by_id")
        cmd.Parameters.AddWithValue("@id", Session.Item(cbo_user.SelectedValue))
        rdr = cmd.ExecuteReader
        If rdr.Read Then
        ...
        command("sp_get_info_by_forign_id")
        cmd.Parameters.AddWithValue("@fid", forign_id)
        rdr = cmd.ExecuteReader
        If rdr.Read Then
            'txt_phone.Text = rdr("phone_number")
            txt_email.Text = rdr("e_mel")
            dept_id = rdr("dept_id")
            txt_joining.Text = rdr("joining_date")
        End If
        '================================
    ...
    Protected Sub btn_cancel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_cancel.Click
        Response.Redirect("edit_dept_emp.aspx")
    End Sub
    ...
    Protected Sub btn_ok_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_ok.Click
        ...
        If cmd.ExecuteNonQuery Then
            command("sp_update_dept_emp_by_id")
            cmd.Parameters.AddWithValue("@id", forign_id)
