<%@ Page Language="VB" MasterPageFile="~/admin_controls_master.master" AutoEventWireup="false" CodeFile="edit_branch_head.aspx.vb" Inherits="edit_branch_head" title="Untitled Page" %>
...
<asp:Panel ID="Panel1" runat="server" GroupingText="Edit Branch Head Info."  Width="750px" CssClass="for_alpha_panal">
   Select Username : 
