...
Partial Class admin_add_new_user_stape_2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        post = Request.QueryString("post_")
        ...
        If post = "BE" Or post = "BH" Or post = "SRBM" Then
            pnl_BE.Visible = True
        ...
        If post = "HOD" Or post = "SRMNG" Then
    ...
    Protected Sub cbo_mngs_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_mngs.SelectedIndexChanged
        ...
        If rdr.Read Then
            ...
            Else
                Page.RegisterStartupScript("ScriptDescription", "<script type=""text/javascript"">alert('Manager for Selected Department Already Exist !')</script>")
