<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Escal_log.aspx.vb"
    Inherits="Escal_log" %>
<%@ Register
        ...
        <div class="welcome_pan4">
            <div class="potion_pan">
                <asp:Panel ID="Panel1" runat="server">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <asp:DropDownList ID="UserDropDownList1" runat="server"  Enabled="False">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="UserData" runat="server" 
                     ...
                     <asp:DropDownList ID="UserDropDownList2" runat="server"  Enabled="False">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="UserData2" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:tn_CAREE_bitaConnectionString2 %>" 
                        SelectCommand="SELECT [name_] FROM [tbl_loginer_master] WHERE ([forign_id] = @forign_id and (post_='HOD' or post_='MNG')) ">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="cbo_depts" Name="forign_id" 
                                PropertyName="SelectedValue" Type="Int32" />
                        </SelectParameters>
                ...
                <asp:Panel ID="Panel2" runat="server" Visible="true">
                    <div id="cont">
                        ...
                        <asp:TextBox ID="txtdatefrom" runat="server" Width="75px"></asp:TextBox>
                                  <ajaxToolkit:CalendarExtender Format="MM/dd/yyyy" ID="cal1" runat="server"  TargetControlID="txtdatefrom" />
                ...
                <div class="admin_updater_long_mid" id="DIV1" language="javascript" onclick="return DIV1_onclick()">
                    ...
                    <asp:GridView ID="GridView1" runat="server" CellPadding="4" GridLines="None"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="EscalationDate" HeaderText="EscalationDate" 
