<%@ Page Language="VB" AutoEventWireup="false" CodeFile="hod_search_tick_by_dept.aspx.vb" Inherits="hod_search_tick_by_dept" %>
...
<body>
	...
	<div class="menu_1">
		<a href="hod_login_Next.aspx" >Home</a>
		<a href="#">About Us</a>
		<a href="#">Support</a>
		<a href="#">Join Us</a>
	</div>	
	...
	<div class="welcome_pan">
		Trade Net Customer Support Login (HOD site Display) 
	</div>
	<div class="main_panal">
		...
		<asp:Panel ID="panal_post_comm" runat="server" Visible=true>
            ...
            <div class="PC_main_pan3">
						...
						Search By : -<asp:RadioButtonList ID="rdb_by" runat="server" 
                                RepeatDirection="Horizontal">
                                <asp:ListItem Selected="True">Subject</asp:ListItem>
